...
def testCHS1():
    ...
    ios = IOS()
    datetimes = np.arange('2000-01-01', '2000-01-02', np.timedelta64(3, 'h'), dtype='datetime64')
...
def testCHS1Parallel():
    ...
    ios = IOS()
    datetimes = np.arange('2000-01-01', '2001-01-01', np.timedelta64(3, 'h'), dtype='datetime64')
    stations = getCHS(csvPath)
